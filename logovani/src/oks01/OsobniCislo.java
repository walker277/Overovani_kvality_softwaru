...
public class OsobniCislo implements Comparable<OsobniCislo> {
  ...
  public static final Logger osobniCisloLogger = (Logger) getLogger();
  ...
  public void generujOsobniCislo(String poradoveCislo) {    
    ...
    osobniCisloLogger.debug(this.vysledek);
  }
  ...
  private void zpracujPrijmeni(String prijmeni) {
    if (prijmeni != null) {
      ...
      osobniCisloLogger.trace("prijmeni: " + Konstanty.ZNAK_CHYBY);
